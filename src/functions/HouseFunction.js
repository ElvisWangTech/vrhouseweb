...
export const getDefaultRoom = function (houseData) {
  if (houseData.Floors) {
    var floor = houseData.Floors[0];
...
export const getDefaultRoomByFloor = function (floorData) {
  if (floorData.Rooms) {
    return floorData.Rooms[0];
  }
  return null;
};
